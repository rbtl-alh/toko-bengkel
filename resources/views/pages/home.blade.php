  ...
  <div class="row header">
    <div class="col-md-5 pb-4 px-4">      
      ...
      <p class="welcome-desc">
        Media website penyedia layanan yang berfokus pada penjualan sparepart barang kendaraan  seperti Ban, Oli dan sebagainya. Kami siap memberikan pelayanan yang lengkap dan original. Dengan pengalaman yang telah didapat, kami siap memberikan pelayanan yang lebih lengkap dan menyeluruh dengan berbagai keunggulan baru bagi setiap pelanggan.
      </p>
      <div class="button">
        <a href="{{ route('product.index') }}" class="btn btn-light">Order Now</a>
      </div>
    </div>
  ...
  <div class="container p-4">
    <div class="row">
      ...
      <div class="row mr-0 ml-0">
        ...
        <div class="col-4 no-gutters mx-auto pb-4">
            <a href="{{ URL('kategori/'. $kategori->id) }}" style="text-decoration: none">
                <div class="card card-kategori">
                    <div class="btn btn-kateogri">
                        ...
                        <img src="{{ \Storage::url($kategori->foto) }}"  alt="" class="d-block m-auto icon-size" />
  ...
  <div class="row mr-0 ml-0 mt-4">
    ...
    <div class="col-4 no-gutters mx-auto">
      <div class="card mb-4 shadow-sm card-layanan">
        <a href="{{ route('trolley.index') }}">
          <img src="{{ asset('images/layanan1.png') }}" alt="foto kategori" class="card-img-top img-layanan" style="height: 180px">
        </a>
        <div class="card-body text-center">
          <a href="{{ route('trolley.index') }}" class="text-decoration-none">
            <p class="card-text">Trolley</p>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="col-4 no-gutters mx-auto">
      <div class="card mb-4 shadow-sm card-layanan">
        <a href="{{ route('product.index') }}">
          <img src="{{ asset('images/layanan2.png') }}" alt="foto kategori" class="card-img-top img-layanan" style="height: 180px">
        </a>
        <div class="card-body text-center">
    ...
    <div class="col-4 no-gutters mx-auto">
      <div class="card mb-4 shadow-sm card-layanan">
        <a href="{{ url('/tracking') }}">
          <img src="{{ asset('images/layanan3.png') }}" alt="foto kategori" class="card-img-top img-layanan" style="height: 180px">
        </a>
        <div class="card-body text-center">
          <a href="{{ url('/tracking') }}" class="text-decoration-none">
            <p class="card-text">Tracking</p>
          </a>
        </div>
      </div>
    </div>
